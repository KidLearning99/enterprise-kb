# [Symptom as Title]
<!-- Example: Printer Shows Online in PaperCut But Jobs Won't Print -->
<!-- Title should describe the symptom, not the fix -->
...
> Describe exactly what the user reports and what you observe.
> Be specific: error codes, error messages, screenshots if possible.
>
> Example: "User reports 'Document failed to print' popup. In PaperCut Admin,
> the printer shows 'Online' with a green status. Print queue on the server
> shows jobs accumulating with 'Error - Printing' status."

## Quick Fix (If One Exists)

<!-- The 30-second fix that works 70% of the time -->
<!-- Example: "Restart the Print Spooler service on the print server:
...
<!-- Decision tree for diagnosis. Use this format: -->
...
- [Related Troubleshoot](./related-entry.md)
- [Related Concept](../Concepts/related-entry.md)

## Incident History

<!-- Log past occurrences for pattern recognition -->
