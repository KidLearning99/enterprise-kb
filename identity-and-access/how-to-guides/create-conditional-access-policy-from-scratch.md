# Create a Conditional Access Policy from Scratch
...
| Sources          | _(Add your LinkedIn saves / company KB source IDs here)_                                                       |
| Prerequisites    | [What Is Conditional Access and How Does It Work?](../concepts/what-is-conditional-access-and-how-it-works.md) |

## The Question

> You need to create a new Conditional Access policy that requires MFA for all users when accessing any cloud app from outside the corporate network. How do you do it from scratch, including testing and rollout?
...
> \[!IMPORTANT] **Always write the logic out before creating the policy.** This prevents misconfigurations, especially the accidental "block everyone from everything" scenario.
...
* [How do you set up and protect break-glass accounts?](../../Identity-Access/How-To/setup-break-glass-accounts.md)
* [How do you block legacy authentication?](../../Identity-Access/How-To/block-legacy-authentication.md)
* [How do you require a compliant device for Office 365?](../../Identity-Access/How-To/require-compliant-device-for-office365.md)
* [Troubleshoot: User unexpectedly blocked by CA](../../Identity-Access/Troubleshoot/user-blocked-by-ca-policy.md)
