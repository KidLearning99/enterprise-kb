...
<!-- TODO: Fill in from your LinkedIn saves and Microsoft Learn -->
...
| Sources | *(Add source IDs — LinkedIn courses, Microsoft Learn)* |
...
| "MFA = Conditional Access" | MFA is one possible *control*. CA is the *engine* that decides when to require it. |
...
### Used By (Downstream)
- [How-To: Create a CA policy from scratch](../How-To/create-conditional-access-policy-from-scratch.md)
- [How-To: Block legacy authentication](../How-To/block-legacy-authentication.md)
- [How-To: Require MFA for all users](../How-To/require-mfa-for-all-users.md)
- [Troubleshoot: User blocked by CA](../Troubleshoot/user-blocked-by-ca-policy.md)
