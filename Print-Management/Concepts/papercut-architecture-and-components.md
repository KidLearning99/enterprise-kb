# PaperCut Architecture and Components
...
| Sources | *(Add your source IDs — PaperCut Manual, company KB docs)* |
...
### Used By (Downstream)
- [How-To: Set up a brand new printer on PaperCut](../How-To/setup-brand-new-printer-on-papercut.md)
- [How-To: Configure Secure Print Release](../How-To/configure-secure-print-release.md)
- [How-To: Configure print quotas](../How-To/configure-print-quotas-and-restrictions.md)
- [Troubleshoot: PaperCut not tracking jobs](../Troubleshoot/papercut-not-tracking-jobs.md)
- [Troubleshoot: Badge release not working](../Troubleshoot/badge-release-not-working.md)
